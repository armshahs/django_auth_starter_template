...
# SECRET_KEY = 'django-insecure-w4rawxu_=0!-2(yu@(2=)rh*d3()f4@_qv_ryzp4^3@s0w02k*'
...
# Djoser Settings
DJOSER = {
    "LOGIN_FIELD": "email",  # to use email instead of username
    "USER_CREATE_PASSWORD_RETYPE": True,
    "ACTIVATION_URL": "/activate/{uid}/{token}",
    # Only make the "SEND_ACTIVATION_EMAIL": False. Then no activation email is needed.
